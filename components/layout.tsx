...
export default function Layout({
  ...
  const imageUrl = "https://www.ghibli.jp/gallery/umi005.jpg";
  ...
  return (
    <div
      className={cls(
        "bg-fixed bg-[length:25%] bg-repeat-x bg-center",
        1 === 3
          ? 1 === 2
            ? "bg-[url(https://www.ghibli.jp/gallery/umi005.jpg)]"
            : "bg-[url(https://www.ghibli.jp/gallery/umi032.jpg)]"
          : "bg-[url(https://www.ghibli.jp/gallery/umi031.jpg)]"
      )}
    >
